...
public class OrderPersistenceService {
    ...
    public OrderDTO prepareAndPersistOrder(List<ReserveProductDTO> reserveProducts, List<ReserveResponseDTO> productsData, String idempotencyKey) {
        ...
        Outbox outbox = Outbox.builder().event(jsonUtils.toJson(event)).topicName("order.inventory.reserve").eventType("RESERVE_PRODUCTS").status(OutboxStatus.PENDING).build();
